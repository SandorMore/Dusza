  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-700">Válaszd ki az alap kártyát</label>
          <select
            required
          ...
          >
            <option value="">Válassz ki egy kártyát fejlesztésre</option>
        ...
        {selectedCard && (
          <div className="bg-gray-50 p-3 rounded-md">
            <p className="text-sm text-gray-600">Választott kártya:</p>
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-violet-500 focus:border-violet-500"
            placeholder="Add meg a Vezérkártya nevét"
          />
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700">Erősítés típusa</label>
          <div className="mt-2 space-y-2">
            <label className="inline-flex items-center">
              ...
              />
              <span className="ml-2">Kétszeres sebzés (2×)</span>
            </label>
            <label className="inline-flex items-center ml-6">
              <input
                ...
                className="text-violet-500 focus:ring-violet-500"
              />
              <span className="ml-2">Kétszeres életerő (2×)</span>
            </label>
          </div>
        </div>
        ...
        >
          {loading ? 'Folyamatban...' : 'Vezérkártya létrehozása'}
        </button>
